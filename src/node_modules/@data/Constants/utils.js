 ...
 * @returns {boolean}
 */
export function isWeekInFuture(week: WeekNrType): boolean {
 ...
 * @returns {*}
 */
export function getDurationDescription(name: string): string {
