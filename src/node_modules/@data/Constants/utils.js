...
/* export function fixDurations(period) {
    const durations = ['per_start', 'per_stop', 'per_duration', 'per_break'];
    return R.mapObjIndexed(
        (val, key) => (_.includes(durations, key) && val !== null ? moment.duration(val) : val),
    )(period);
} */
...
export function getDurationType(period, targetTime, type) {
...
export function assocPeriodWithType(typeMap, targetTime, period) {
...
export function assocPeriodsWithTypes(types, days) {
...
const periodUnfinished = period => (!!period.per_start === !!period.per_stop);
...
export function processWeek(carry, weekDays, weekNumber) {
