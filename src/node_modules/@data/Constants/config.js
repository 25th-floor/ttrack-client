...
export const client = {
    get: (uri: string) => fetch(`${API_URI}${uri}`, GET).then(response => response.json()),
    post: (uri: string, body: any) => fetch(`${API_URI}${uri}`, { ...POST, body: JSON.stringify(body) }).then(response => response.json()),
    put: (uri: string, body: any) => fetch(`${API_URI}${uri}`, { ...PUT, body: JSON.stringify(body) }).then(response => response.json()),
    delete: (uri: string) => fetch(`${API_URI}${uri}`, DELETE),
};
