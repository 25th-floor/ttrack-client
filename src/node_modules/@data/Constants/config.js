...
export const client = {
    get: async (uri: string) => await fetch(`${API_URI}${uri}`, GET).then(toJson),
    post: async (uri: string, body: any) => await fetch(`${API_URI}${uri}`, { ...POST, body: JSON.stringify(body) }).then(toJson),
    put: async (uri: string, body: any) => await fetch(`${API_URI}${uri}`, { ...PUT, body: JSON.stringify(body) }).then(toJson),
    delete: async (uri: string) => await fetch(`${API_URI}${uri}`, DELETE),
};
